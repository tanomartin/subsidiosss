...
<script type="text/javascript">
	...
	function buscar(id) {
		...
		if (cuit!="") {
			var pagina = "presentacion.pagoscuit.php?id="+id+"&cuit="+cuit;
				 	...
				 	<div class="grilla" style="margin-bottom: 20px;">
					 	<table>
					 		...
					 		<tbody>
					 			...
					 			<td><?php echo number_format($rowPagos['retingresosbrutos'],"2",",","."); ?></td>
					 			<td><?php echo number_format($rowPagos['retganancias'],"2",",","."); ?></td>
					 			<td><?php echo number_format($rowPagos['importepagado'],"2",",","."); ?></td>
