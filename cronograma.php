	...
	<div align="center">
	 ...
	 <div class="grilla">
		...
		<?php while ($rowCronograma = mysql_fetch_array($resCronograma)) {  ?>
				<tr>
					<td><?php echo $rowCronograma['periodo'] ?></td>
					<td><?php echo $rowCronograma['carpeta'] ?></td>
					<td><?php echo $rowCronograma['fechacierre'] ?></td>
					<td><?php echo $rowCronograma['periodosincluidos'] ?></td>
				</tr>
		<?php } ?>
		  	</tbody>
		</table>
